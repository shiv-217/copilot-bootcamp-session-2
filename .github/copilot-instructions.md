...
The project documentation will be built during the bootcamp sessions. All new documentation files added under the `docs/` folder should be referenced here for easy access.
